...
export default function Navbar() {
    ...
    return (
        <nav className="px-4 text-black flex border-b-1 w-full" style={{borderColor: 'rgba(0, 0, 0, 0.12)'}}>
            <div className="container m-auto">
                <div className='justify-between py-2 flex flex-row items-center w-full'>
